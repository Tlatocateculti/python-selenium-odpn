...
class SiteWrap:
    ...
    def selectBills(self):
        ...
        menuExe = WebDriverWait(self.driver,self.waitTime if self.szkolaRozdzial !=0 else float('inf')).until(EC.presence_of_element_located((By.CSS_SELECTOR, "#ext-comp-1048__dokumentId_14")))
        menuExe.click()
